...
/* harmony export */ });
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3621);
/* harmony import */ var _CarItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1378);
...
const CarItemList = ({
  ...
  if (isLoading) {
    return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx(_styles__WEBPACK_IMPORTED_MODULE_0__/* .CardItemListWrapper */ .T, {
  ...
  return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx(_styles__WEBPACK_IMPORTED_MODULE_0__/* .CardItemListWrapper */ .T, {
    children: carItemData.map(carData => /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx(_CarItem__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
      carData: carData
    }, carData.id))
  });
};
...
/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1372);
/* harmony import */ var _ItemTag__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4604);
...
const CarItem = ({
  ...
  const {
    day,
    calculateDate
  } = (0,_lib_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useCalculateDate */ .fn)();
  const {
    amountLocalString,
    changeLocalString
  } = (0,_lib_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useChangeAmountToLocalString */ .tB)();
  const {
    fuel,
    segment,
    changeFuelToKorean,
    changeSegmentToKorean
  } = (0,_lib_hooks__WEBPACK_IMPORTED_MODULE_4__/* .useChangeFuelSegmentEnumToKorean */ .BL)();
  ...
  return /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx(_styles__WEBPACK_IMPORTED_MODULE_1__/* .Container */ .W, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("div", {
        ...
        children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx("p", {
          ...
          className: "amount",
          children: ["\uC6D4 ", amountLocalString, " \uC6D0 \uBD80\uD130"]
        })]
      ...
      }), day < 1 && /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx(_ItemTag__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
...
;// CONCATENATED MODULE: ./src/Components/Tag/styles.tsx
...
const TagWrapper = external_styled_components_default().button.withConfig({
  ...
  selected,
  theme
}) => (0,external_styled_components_.css)(["background-color:", ";color:", ";"], selected ? theme.color.black : theme.color.gray, selected ? theme.color.white : theme.color.black));
// EXTERNAL MODULE: ./src/lib/types/types.ts
var types = __webpack_require__(5175);
;// CONCATENATED MODULE: ./src/lib/types/index.ts
...
;// CONCATENATED MODULE: ./src/Components/Category/styes.tsx
...
const Category = ({
  ...
  return /*#__PURE__*/jsx_runtime_.jsx(CategoryWrapper, {
    children: categoryData.map((segment, index) => /*#__PURE__*/jsx_runtime_.jsx(Components_Tag, {
      index: index,
...
var external_styled_components_ = __webpack_require__(7518);
var external_styled_components_default = /*#__PURE__*/__webpack_require__.n(external_styled_components_);
;// CONCATENATED MODULE: ./src/Components/ItemTag/styles.tsx
...
const Container = external_styled_components_default().span.withConfig({
  ...
  theme
}) => (0,external_styled_components_.css)(["font-size:", ";background-color:", ";color:", ";"], theme.fontSize.XSmall, theme.color.blue, theme.color.white));
// EXTERNAL MODULE: external "react/jsx-runtime"
var jsx_runtime_ = __webpack_require__(997);
;// CONCATENATED MODULE: ./src/Components/ItemTag/index.tsx
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "BL": () => (/* reexport safe */ _useChangeFuelSegmentEnumToKorean__WEBPACK_IMPORTED_MODULE_2__.Z),
/* harmony export */   "F": () => (/* reexport safe */ _useCarList__WEBPACK_IMPORTED_MODULE_5__.Z),
/* harmony export */   "XX": () => (/* reexport safe */ _useCar__WEBPACK_IMPORTED_MODULE_4__.Z),
/* harmony export */   "fn": () => (/* reexport safe */ _useCalculateDate__WEBPACK_IMPORTED_MODULE_0__.Z),
/* harmony export */   "pD": () => (/* reexport safe */ _useChangeDetailData__WEBPACK_IMPORTED_MODULE_3__.Z),
/* harmony export */   "tB": () => (/* reexport safe */ _useChangeAmountToLocalString__WEBPACK_IMPORTED_MODULE_1__.Z)
/* harmony export */ });
/* harmony import */ var _useCalculateDate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(154);
/* harmony import */ var _useChangeAmountToLocalString__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7794);
/* harmony import */ var _useChangeFuelSegmentEnumToKorean__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7741);
/* harmony import */ var _useChangeDetailData__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2425);
/* harmony import */ var _useCar__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6913);
/* harmony import */ var _useCarList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3268);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useCalculateDate);
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(742);
...
const useCar = id => {
  const {
    ...
    data,
    error
  } = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_1__.useQuery)(["cars", "ALL"], _api__WEBPACK_IMPORTED_MODULE_0__/* .getCars */ .R, {
...
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(742);
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9752);
/* harmony import */ var _pages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(2779);
...
const useCarList = () => {
  ...
  const {
    ...
    data,
    error
  } = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_1__.useQuery)(["cars", currentCategory], _api__WEBPACK_IMPORTED_MODULE_0__/* .getCars */ .R, {
    onError: error => error
  });
  return {
    isLoading,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useChangeAmountToLocalString);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8169);
...
const useChangeDetailData = data => {
  ...
  const {
    amountLocalString,
    changeLocalString
  } = (0,___WEBPACK_IMPORTED_MODULE_1__/* .useChangeAmountToLocalString */ .tB)();
  const {
  ...
  const {
    ...
    changeFuelToKorean,
    changeSegmentToKorean
  } = (0,___WEBPACK_IMPORTED_MODULE_1__/* .useChangeFuelSegmentEnumToKorean */ .BL)();
  const {
    month,
    week,
    date,
    calculateDate
  } = (0,___WEBPACK_IMPORTED_MODULE_1__/* .useCalculateDate */ .fn)();
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (data) {
      const {
        id,
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _types_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5175);
"use client";
...
const useChangeFuelSegmentEnumToKorean = () => {
  ...
  const changeFuelToKorean = fuelTypeKey => {
    setFuel(_types_types__WEBPACK_IMPORTED_MODULE_1__/* .FUELTYPE */ .B[fuelTypeKey]);
  };

  const changeSegmentToKorean = segmentType => {
    setSegment(_types_types__WEBPACK_IMPORTED_MODULE_1__/* .SEGMENT */ .o[segmentType]);
  };
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (useChangeFuelSegmentEnumToKorean);
...
/* harmony export */ });
/* harmony import */ var _Components_Category__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2875);
/* harmony import */ var _Components_CarItemList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8676);
/* harmony import */ var _lib_hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8169);
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9752);
/* harmony import */ var _lib_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(742);
...
const Index = () => {
  const {
    ...
    currentCategory,
    setCurrentCategory
  } = (0,_lib_hooks__WEBPACK_IMPORTED_MODULE_2__/* .useCarList */ .F)();
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
    children: [/*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx(_Components_Category__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z, {
      categoryData: categoryData,
      currentCategory: currentCategory,
      setCurrentCategory: setCurrentCategory
    }), /*#__PURE__*/react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx(_Components_CarItemList__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
      isLoading: isLoading,
      carItemData: cars
    })]
  });
...
const getServerSideProps = async () => {
  ...
  await queryClient.prefetchQuery(["cars", "ALL"], _lib_api__WEBPACK_IMPORTED_MODULE_4__/* .getCars */ .R);
  return {
    props: {
